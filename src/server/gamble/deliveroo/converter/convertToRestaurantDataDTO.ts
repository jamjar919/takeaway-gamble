...
const convertToRestaurantDataDTO = (
    ...
    const selectedPlaceMeta = getPlaceToEatMetaFromDeliverooState(restaurantContext);
    ...
    return {
        ...
        isAvailable: !selectedPlaceMeta.restaurant.menuDisabled && selectedPlaceMeta.restaurant.deliversToCustomerLocation
    };
};
